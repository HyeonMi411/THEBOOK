...
<div class="form-container">
    ...
    <form action="${pageContext.request.contextPath}/book/edit?bookId=${book.bookId}" method="post"
     enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label>랭킹</label>
            <input type="text" name="ranking" value="${book.ranking}">
        </div>

        <div class="form-group">
            <label>조회수</label>
            <input type="text" name="reviewCount" value="${book.reviewCount}">
        </div>
        ...
        <div class="form-group">
            <label>책 표지 이미지 URL</label>
     	    <img src="${pageContext.request.contextPath}/upload/${book.bookCover}"  class="w-25">
        </div>
