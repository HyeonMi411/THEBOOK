...
public class ApiEmail {	
	...
	@Value("${naver.user}")		private String user;		//	jewelkhm@naver.com
	...
	public void sendMail( String subject, String content,String to ) {
	      ...
	      try {
	         message.setFrom(  new  InternetAddress(user));		// 보내는 사람 -  jewelkhm@naver.com
	         message.addRecipient(Message.RecipientType.TO, new  InternetAddress(to));		// 반는사람   
...
//1. Naver - 이메일 (로그인)  - smtp.naver.com   / jewelkhm@naver.com
//2. 2차보안 - 비밀번호        -  39EJ4PF994KU
//3. Service
//4. Controller
//5. view 