...
function AppLayout({ children }) {
    ...
    return (
        <Layout className="bookstore-body">
            ...
            {/* overflow: hidden 을 걸어두지 않음 - wrap={false} 로 줄바꿈 자체를 막고 있어서
                불필요했을 뿐 아니라, 검색창 드롭다운(.bs-search-result-box)이 Header 의
                고정 높이 아래로 펼쳐질 때 overflow: hidden 에 의해 그대로 잘려서 안 보이는
                문제가 있었음(z-index 를 아무리 높여도 overflow 로 잘리는 건 막지 못함) */}
