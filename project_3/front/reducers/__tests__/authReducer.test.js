...
describe('user slice reducer' , ()=>{
    ...
    it('signupSuccess' , ()=>{     
        ...
        // state.user 대입 로직이 의도적으로 주석처리되어 있음. (로그인은 별도 로그인
        // 화면에서 진행) 그래서 state.user 는 계속 null 로 유지되는 게 정상 동작임.
    ...
    //////////////////////////////////////////// 로그인
     it('loginSuccess' , ()=>{    
        ...
        //  action.payload.user / action.payload.accessToken 을 각각 꺼내 저장.
        //  (예전에는 payload 를 user 객체로 바로 썼지만 지금은 {user, accessToken} 중첩구조 임.)
